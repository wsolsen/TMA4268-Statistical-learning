...
We see that the fraction of variance explained by the model is estimated to be: `r est_mean` and that there is a 95% probability that the true fraction of variance explained by the model lies in the interval [`r est_mean-2*rse`, `r est_mean+2*rse`]