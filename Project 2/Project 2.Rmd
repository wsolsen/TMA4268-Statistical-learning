...
```{r,eval = T, echo=F,fig.width=11,fig.height=7,out.width="100%"}
par(mfrow=c(2,3))
...
plot(hc.Gene.EcC, main="Complete Linkage",xlab="",ylab="",sub="Euclidean distance")
plot(hc.Gene.EcS, main="Single Linkage",xlab="",ylab="",sub="Euclidean distance")
plot(hc.Gene.EcA, main="Average Linkage",xlab="",ylab="",sub="Euclidean distance")
plot(hc.Gene.CorrC, main="Complete Linkage",xlab="",ylab="",sub="Correlation distance")
plot(hc.Gene.CorrS, main="Single Linkage",xlab="",ylab="",sub="Correlation distance")
plot(hc.Gene.CorrA, main="Average Linkage",xlab="",ylab="",sub="Correlation distance")
```
...
informative_loadings = rbind(
  head(GeneLoad[order(GeneLoad[,1], decreasing = TRUE),]),
  head(GeneLoad[order(GeneLoad[,2], decreasing = TRUE),])
  )
